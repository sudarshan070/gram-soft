...
import { getVillageIdsForUser, findUserByEmail } from "@/server/modules/users/userRepo";
...
export async function POST(req: Request) {
  try {
    ...
    const villageIds = user.role === "SUPER_ADMIN" ? [] : await getVillageIdsForUser(String(user._id));
